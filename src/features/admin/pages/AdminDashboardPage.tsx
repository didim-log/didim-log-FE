...
export const AdminDashboardPage: FC = () => {
    ...
    const isValidTab = (value: string | null): value is TabType =>
        ...
        value === 'logs' ||
        value === 'audit';
    const [activeTab, setActiveTab] = useState<TabType>(isValidTab(requestedTab) ? requestedTab : 'dashboard');
                        ...
                        {activeTab === 'dashboard' && (
                            <div className="space-y-8">
                                {isLoading ? (
                                    ...
                                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 border border-gray-200 dark:border-gray-700">
                                        <h2 className="text-xl font-bold text-red-600 dark:text-red-400 mb-2">통계 로드 실패</h2>
