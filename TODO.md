...
- [x] **[FE]** 추천 문제 전체 보기 페이지에 "한국어 문제만" 필터 추가 및 대시보드와 UI 통일
...
- [x] **[FE]** 회고 목록 보관 기한(60일 자동 삭제) 안내 문구 추가
- [x] **[Fix]** 온보딩 투어 7/8단계 타겟 로딩 불일치로 툴팁이 사라지는 문제 개선

### 4-10. 최적화 및 배포
- [x] **[FE]** 코드 스플리팅 및 라우트 레이지 로딩
- [ ] **[FE]** 이미지 최적화
- [ ] **[FE]** 성능 최적화 (React.memo, useMemo, useCallback)
- [x] **[FE]** Firebase Hosting 배포 설정
- [x] **[FE]** 환경 변수 설정 (.env)
