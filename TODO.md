...
### 4-3. 메인 대시보드
- [ ] **[FE]** 대시보드 레이아웃 컴포넌트 구현
- [ ] **[FE]** 현재 티어 표시 컴포넌트
- [ ] **[FE]** 최근 풀이 그래프 컴포넌트 (Chart.js 또는 Recharts)
- [ ] **[FE]** 추천 문제 요약 카드 컴포넌트
- [ ] **[FE]** 대시보드 API 연동 (@tanstack/react-query)

### 4-4. 문제 풀이 화면
- [ ] **[FE]** 문제 상세 페이지 UI 구현
- [ ] **[FE]** 타이머 기능 구현 (시작/일시정지/종료)
- [ ] **[FE]** 문제 풀이 결과 제출 API 연동
- [ ] **[FE]** 종료 시 모달 팝업 구현 (성공/실패 결과 표시)

### 4-5. 인터랙션 효과
- [ ] **[FE]** 성공 시 `canvas-confetti` 이펙트 구현
- [ ] **[FE]** 실패 시 Shake 애니메이션 구현 (Tailwind CSS)
- [ ] **[FE]** 로딩 상태 UI 구현 (Skeleton 또는 Spinner)

### 4-6. 회고 작성 기능
- [ ] **[FE]** Markdown 에디터 컴포넌트 구현 (react-markdown 또는 CodeMirror)
- [ ] **[FE]** 회고 작성 페이지 UI 구현
- [ ] **[FE]** 회고 템플릿 자동 생성 기능
- [ ] **[FE]** 회고 CRUD API 연동
...
### 4-7. 문제 추천 시스템 UI
- [ ] **[FE]** 추천 문제 목록 페이지 구현
- [ ] **[FE]** 문제 필터링 기능 (난이도, 카테고리)
- [ ] **[FE]** 문제 상세 정보 모달/페이지 구현

### 4-8. 공통 컴포넌트
- [ ] **[FE]** Button 컴포넌트 (variants, sizes)
- [ ] **[FE]** Input 컴포넌트
- [ ] **[FE]** Card 컴포넌트
- [ ] **[FE]** Modal 컴포넌트
- [ ] **[FE]** Loading 컴포넌트
- [ ] **[FE]** Error Boundary 구현

### 4-9. 스타일링 및 UX 개선
- [ ] **[FE]** 다크모드 지원 (선택사항)
- [ ] **[FE]** 반응형 디자인 적용 (Mobile, Tablet, Desktop)
- [ ] **[FE]** 접근성 개선 (ARIA 속성, 키보드 네비게이션)
- [ ] **[FE]** 에러 처리 및 사용자 피드백 개선
